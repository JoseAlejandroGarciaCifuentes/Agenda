...
class Requests {
    ...
    func deleteUser(api_token:String) -> DataRequest {
        ...
        return AF.request(Endpoints.shared.localMac + Endpoints.shared.cevUrl + Endpoints.shared.delete, method: .get, parameters: nil, encoding: URLEncoding.default, headers: headers)
        }
    ...
    func updatePassword(password:String, api_token:String) -> DataRequest {
        ...
        let headers:HTTPHeaders = ["api_token":api_token]
        let parameters:Parameters = ["new password":password]
        
        return AF.request(Endpoints.shared.localMac + Endpoints.shared.cevUrl + Endpoints.shared.updatePassword, method: .post, parameters: parameters, encoding: URLEncoding.default, headers: headers)
    ...
    func getProfileInfo(api_token:String) -> DataRequest {
        ...
        return AF.request(Endpoints.shared.localMac + Endpoints.shared.cevUrl + Endpoints.shared.getProfileInfo, method: .get, parameters: nil, encoding: URLEncoding.default, headers: headers)
